...
registerMooseObject("MgCorrosionApp", DarcyPressure);
...
DarcyPressure::validParams()
{
  ...
  // Add a required parameter. If this isn't provided in the input file will error.
...
DarcyPressure::DarcyPressure(const InputParameters & parameters)
  ...
  // Set the coefficients for the pressure ADkernel
